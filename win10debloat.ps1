...
$devtools.text                   = "Install Developer Tools"
$devtools.width                  = 150
$devtools.height                 = 30
$devtools.location               = New-Object System.Drawing.Point(250,19)
$devtools.Font                   = New-Object System.Drawing.Font('Microsoft Sans Serif',12)

$basetools                       = New-Object system.Windows.Forms.Button
$basetools.text                  = "Firefox"
$basetools.width                 = 150
$basetools.height                = 30
$basetools.location              = New-Object System.Drawing.Point(250,61)
$basetools.Font                  = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$msiafterburner                  = New-Object system.Windows.Forms.Button
$msiafterburner.text             = "MSI Afterburner"
$msiafterburner.width            = 150
$msiafterburner.height           = 30
$msiafterburner.location         = New-Object System.Drawing.Point(417,19)
$msiafterburner.Font             = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$plex                            = New-Object system.Windows.Forms.Button
$plex.text                       = "Plex Server"
$plex.width                      = 150
$plex.height                     = 30
$plex.location                   = New-Object System.Drawing.Point(417,104)
$plex.Font                       = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$audacity.width                  = 150
$audacity.height                 = 30
$audacity.location               = New-Object System.Drawing.Point(584,61)
$audacity.Font                   = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$Panel1.controls.AddRange(@($installchoco,$devtools,$basetools,$7zip,$msiafterburner,$adobereader,$plex,$gchrome,$audacity,$vlc,$powertoys,$winterminal,$vscode,$Label2))
...
$devtools.Add_Click({ 
    Write-Host "Installing PowerShell Core, Docker, Insomnia, Starship, Cascadia Code, Git, Windows Terminal, VS Code"
    choco install powershell-core docker-desktop insomnia-rest-api-client starship cascadiacodepl git microsoft-windows-terminal vscode -y
	$wshell.Popup("Operation Completed",0,"Done",0x0)
})

$basetools.Add_Click({ 
    Write-Host "Installing VLC, 7zip, Discord, Lightshot, PowerToys, Geek Uninstaller"
    choco install vlc 7zip discord lightshot powertoys geekuninstaller -y
	$wshell.Popup("Operation Completed",0,"Done",0x0)
})

$msiafterburner.Add_Click({ 
...
$plex.Add_Click({ 
    Write-Host "Installing Plex Server"
